...
\cref{alg:helpers} to handle \CreatesMustCallFor as follows ($[\ldots]$ stands for the cases shown previously,
...
treated as \<@MustCall(\{\})>, and \CreatesMustCallFor annotations
