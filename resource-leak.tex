...
\begin{abstract}
  ...
  have a variety of drawbacks: they are either slow, unsound,
  imprecise, not applicable to existing code, or a combination
  ...
  to sound checking with no alias analysis.  We developed a
  baseline sound and modular leak checker via this approach.
  % Rashmi said the following was too negative, and I agree:
  % , but found
  % that it suffered from an excess of false positives.
  To improve the precision of this sound analysis,
  we introduce three innovations:
  a lightweight ownership tracking system;
  a specialized, inexpensive resource alias analysis;
  and an extension to the theory of accumulation analysis
  that allows us to check that re-assignments to non-final fields
  ...
  This approach occupies a unique slice of the design space when compared
  to prior approaches: it maintains soundness, but has relatively low overhead
  and runs quickly compared to heavier-weight approaches.
  We implemented our techniques in an open-source tool,
  called \tool, for Java, and show that it
...
\begin{acks}
Thanks to Rashmi Mudduluru, Ben Kushigian, and the anonymous reviewers for their comments on an earlier versions of this paper.
\end{acks}

%% The next two lines define the bibliography style to be used, and
%% the bibliography file.
\bibliographystyle{ACM-Reference-Format}
\bibliography{temp,bib/types,bib/dispatch,bib/ernst,bib/soft-eng,bib/crossrefs}
