...
\begin{abstract}
  ...
  that allows us to soundly reset analysis state when a non-final resource field
  is updated.
  ...
  to prior approaches: it is sound, has relatively low overhead \manu{what kind
  of overhead are we talking about?},
