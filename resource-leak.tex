...
\begin{abstract}
  ...
  developers.
  We \todo{desire} a method for preventing resource leaks that
  is both lightweight, with a minimal annotation burden, and modular,
  to enable scalability.\todo{``desire'' in the previous sentence makes
    it sound like we won't do it. Find a better word?}
  ...
  \emph{lightweight ownership tracking},
  \emph{resource alias analysis},
  and \emph{accumulation frames}.
  ...
  We implemented our techniques in an open-source tool, called \tool, for Java, and show that it
