...
\settopmatter{printfolios=true,printccs=false,printacmref=false,authorsperrow=4}
...
\begin{abstract}
  ...
  targeted aliasing information, and we devised three such novel techniques:
  ...
  %\todo{mention ``unsound''?}
  (running in minutes on programs that a
...
\copyrightyear{2021} 
\acmYear{2021} 
\acmConference[ESEC/FSE '21]{Proceedings of the 29th ACM Joint European Software Engineering Conference and Symposium on the Foundations of Software Engineering}{August 23--27, 2021}{Athens, Greece}
\acmBooktitle{Proceedings of the 29th ACM Joint European Software Engineering Conference and Symposium on the Foundations of Software Engineering (ESEC/FSE '21), August 23--27, 2021, Athens, Greece}\acmDOI{10.1145/3468264.3468576}
...
an accumulation analysis\todo{Not just that: also another type system and a
  dataflow analysis.  This relates to comments in the introduction.} augmented by three new features to handle aliasing
...
Its analysis speed is orders\todo{or ``an order''?} of magnitude faster
