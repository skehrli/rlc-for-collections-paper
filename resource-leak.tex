...
\begin{abstract}
  ...
  and runs quickly compared to heavier-weight\todo{mention ``unsound''?}
  ...
  called \tool.
  \Tool revealed 48 real resource leaks in widely-deployed software.
  It scales well, has a manageable false positive rate
  (lower than the high-confidence
...
effective: it discovered 48 resource leaks in heavily-used, heavily-tested Java code that
