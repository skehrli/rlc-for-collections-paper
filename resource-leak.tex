...
\begin{abstract}
  ...
  it.  Resource leaks are an important, common problem that cause resoure
  starvation, slowdowns, and crashes.  Previous techniques
  to prevent resource leaks are slow, unsound,
  imprecise, inapplicable to existing code, or a combination
  ...
  to prior approaches: it is sound, has relatively low overhead,
