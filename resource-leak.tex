...
effective: it discovered 45 bugs in heavily-used, heavily-tested Java code that
...
of only 1 annotation per 2,000 lines of code. In future work, we plan to develop
...
search and machine-learning techniques could be used to find an optimal placement
of ownership annotations that minimizes \Tool warnings.
