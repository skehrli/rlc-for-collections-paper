...
\begin{abstract}
  ...
  We observe that detecting a resource leak from a variable involves three
  ...
  An advantage of using an accumulation analysis is
  that relevant aliasing information computed by a specialized analysis
  can improve its precision, and we devised three innovations
