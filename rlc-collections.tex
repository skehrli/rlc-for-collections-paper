...
%%% by Martin Kellogg, Sascha Kehrli, Manu Sridharan, and Michael D. Ernst.
%%%
...
\acmISBN{TODO}
\acmConference[ISSTA '25]{34'th ACM SIGSOFT International Symposium on Software Testing and Analysis (ISSTA)}{TODO}{Trondheim, Norway}
\acmBooktitle{TODO}
...
\title{Resource Leak Verification for Collections}
...
\begin{abstract}
  ...
  % socket or file handle, but fails to deallocate it.
  % Resource leaks cause resource starvation, slowdowns, and crashes.
  % 
...
CCF-2005889 and CCF-2007024, a gift from Oracle Labs, and a Google
Research Award.
\end{acks}
