...
is more precise but
suffers from unsoundness and longer run times.
...
% The next sentence is redundant.
...
Other techniques detect common misuse of
...
to apply \tool to more programs from their study.
...
in turn enables guaranteeing other properties, like the absence of
...
compensation stacks make resource leaks less likely, they do not
