...
have been rejected.\todo{Should we also include the links to the patches here?
  ...
  could add a citation for each one?}
...
\begin{table*}
  ...
  \begin{tabularx}{\linewidth}{@{}X||rrrrrr||rrrrrr@{}}
    \multirow{2}{*}{Project}             & \multicolumn{6}{c}{\textbf{Grapple}} & \multicolumn{6}{c}{\textbf{Resource Leak Checker}} \\
                                         &  TPs   & Present & Found & Not Found  &  FPs  &     Run time    &  TPs  & Present & Found & Not Found  &    FPs  & Run time  \\
    \hline
    \grappletableproject{ZooKeeper}      & 4 (6)  &   1     &   1   &    0       &   0   &    01h 07m 02s  &  13   &    6    &  1    &     5      &     48  &  1m 24s  \\
    \grappletableproject{HDFS}           &   5    &   2     &   0   &    2       &   2   &    01h 54m 52s  &  22   &    7    &  0    &     7      &     48  &  16m 21s \\
...
versions
% MK: we decided not to do this
% \todo{Why don't we repeat our experiments on those earlier versions?
...
Grapple's leak detection on our versions of the benchmarks,
due to various hardcoded paths in its source code and limited documentation.
According to the Grapple authors, the primary student author has graduated and
is unable or unwilling to assist.  The other authors are only able to point us
to the relevant source code.
Hence, at this point the Grapple results cannot be reproduced nor can Grapple be
applied to new programs---either by us or by the Grapple authors.
Also, full details
