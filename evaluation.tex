...
\begin{table}
  ...
  \todo{Order these by how common they are, once
...
\begin{table}
  ...
  \begin{tabularx}{\columnwidth}{@{}Xrrr@{}}
    ...
    \abltablerow{apache/hadoop}                   {95}            {113}             {?}                               \\
    \abltablerow{apache/hbase}                  {52}            {57}             {?}                               \\
    \hline
    \abltablerow{\textbf{Total}}                {213}            {267}             {?}                               \\
  \end{tabularx}
\end{table}
...
on HBase, at its two \ResetMustCall annotations), it permits verification
of a complex pattern---the use of non-final, owning fields---that is used in a
few critical places in each\todo{Does this mean, ``in the other two
  benchmarks but not in HBase''?} benchmark.
