...
\begin{table}
  ...
  \begin{tabularx}{\columnwidth}{@{}Xrrrr@{}}
    Project                              &    w/o LO & w/o RA & w/o OC{\color{red}\dag} & RLC     \\
    \hline
    \abltablerow{apache/zookeeper}              {117}            {158}             {47}      {48}                         \\
    \abltablerow{apache/hadoop}                   {97}            {184}             {58}    {49}                           \\
    \abltablerow{apache/hbase}                  {82}            {93}             {26}       {22}                        \\
    \abltablerow{plume-lib/plume-util}          {4}                {11}             {2}         {2}                    \\
    \hline
    \abltablerow{\textbf{Total}}                {300}            {446}             {133}    {121}                           \\
  \end{tabularx}
\end{table}

\marginnote{\footnotesize \color{red} \dag
  The ``w/o OC'' column has~been \mbox{corrected} and differs slightly from the originally-published
  version.}[-11.05cm]
