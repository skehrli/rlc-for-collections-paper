...
\begin{figure}
  ...
  \caption{A resource leak that \tool found in Hadoop. Hadoop's developers
    ...
    to fix it\todo{add citation to the URL}.}
...
allow resources not to be closed on definitely-null paths.\looseness=-1
...
are rare\todo{I suggest cutting the rest of this sentence.  It doesn't add
  much and we don't give that information for any othre features.  Most
...
orders\todo{Earlier, the paper claimed ``an order''.  I would be inclined
  to err on the side of caution, sticking with ``an order''.} of
