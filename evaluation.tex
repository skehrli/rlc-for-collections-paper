...
\begin{table*}
  ...
  \begin{tabular}{@{}lrr|rr|rrrr@{}}
    Project                              &      LoC      & Resources   &  Diff size  & Annos.   & TPs  & Conf    & FPs & Wall-clock time      \\
    \hline
...
false positives from our analysis (``Diff size''). We then examined
...
We submitted bug reports and patches to the projects describing true
positives, when time permitted.  We also measured the number of
