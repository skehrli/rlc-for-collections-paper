...
these case studies is 29\% (49/171). Though there are more false positives
than true positives,
...
allow resources not to be closed on definitely-null paths\todo{Wait, does this
mean our checker cannot verify \cref{fig:example}?  That would be awkward.}.\looseness=-1
