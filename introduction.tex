...
FSM whenever a relevant operation is performed. \todo{say somewhere that ``going
out of scope'' is an operation when formulating leaks as typestate?}
...
manner~\cite{raii} \todo{The reference comes out oddy; there is no book title};
