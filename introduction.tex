...
\todo{cite} can prevent nearly all resource leaks, but the require
...
FSM whenever a relevant operation is performed.\todo{That description
  leaves out the ``type'' part of ``typestate''.}
