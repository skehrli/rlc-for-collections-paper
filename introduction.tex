...
Microsoft engineers consider resource leak defects to be one of the most
...
results---and
can find more complex defects than bug-finders, though they usually remain
unsound---but
...
\item storing of resources in final fields, in a standard RAII
manner~\cite{raii};
...
\item a system for creating new obligations at locations other than the
  constructor, which allows our system to handle lazy or multiple initialization.
\end{itemize}
...
unlike most prior work, it is sound; it is at least one order of magnitude faster than
