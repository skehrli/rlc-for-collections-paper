...
\todo{Although \<@MustCall("close")> is the default type for \<Socket t>, I
  suggest we write it out explicitly, or write a comment, because I don't
  think that will be obvious to readers.}
...
Unlike ownership type systems\todo{cite},
...
\label{sec:owning-fields}
  ...
  considers instance fields.  We have not observed\todo{How would we have
    observed it?  Does this footnote want to say that our technique is sound but not
    precise for static fields?} resource leaks
  ...
  \Cref{sec:reset-must-call} describes our novel handling of non-final fields.
