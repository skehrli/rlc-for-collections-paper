...
\label{sec:owning-fields}
  ...
  \begin{enumerate}
    ...
    \MustCall obligation.
  \end{enumerate}
  In this manner, \tool modularly verifies the \MustCall obligaation of $f$.  Condition 2 is
  ...
  \Cref{sec:non-final-owning} describes our novel handling of non-final fields.
