...
Further, unlike ownership type systems\todo{cite},
...
With lightweight ownership, a parameter, return, or field may be annotated
as either \<@Owning> or \<@NotOwning>.
%% MK: it's not a type system. I clarified above.
...
ownership:
%% MK: I think I've reworded this to be sufficiently clear, or at least to match the implementation.
