...
\begin{table}
  \caption{The annotations we wrote in the case study programs.
    %% \todo{Should we add a frequency column to this table? We mention
    %%   annotation frequency in the main text a few times, and the table has
    %%   horizontal space we could use.}
  }
  \label{tab:annos}
  \posttablecaption
